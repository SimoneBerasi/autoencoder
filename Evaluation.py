...
weights_file = '/home/simo/Desktop/Thesis Projects/DefaultBiondaAutoencoder/Weights/new_weights/cwssim_weights.h5'
anomaly_metrics = 'cw_ssim'
cut_size = (0, 1024, 0, 1024)
#cut_size = (0, 696, 0, 1024)
...
def compute_performance(args):
    ...
    return {'tpr': tpr, 'fpr': fpr, 'iou': 0, 'ovr': 0}
...
def evaluation_complete():
    ...
    imgs = load_images("/home/simo/Desktop/Thesis Projects/DefaultBiondaAutoencoder/Dataset/SEM/Anomalous/images", 512, preprocess_limit=0, cut_size=cut_size)
    gts = load_images("/home/simo/Desktop/Thesis Projects/DefaultBiondaAutoencoder/Dataset/SEM/Anomalous/gt", 512, preprocess_limit=0, cut_size=cut_size)
...
def evaluation (n_img, valid_img, valid_gt, to_show):
    ...
    autoencoder.load_weights("/home/simo/Desktop/Thesis Projects/DefaultBiondaAutoencoder/Weights/new_weights/cwssim_weights.h5")
    #autoencoder.summary()
